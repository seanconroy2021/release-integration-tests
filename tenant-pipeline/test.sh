...
APPLICATION_NAME="tenant-pipeline"
COMPONENT_NAME="tenant-pipeline-component"
RELEASE_PLAN_NAME="tenant-pipeline-rp"
RELEASE_PLAN_ADMISSION_NAME="tenant-pipeline-rpa"
TIMEOUT_SECONDS=600
...
# Get name of Release CR associated with Release Plan "tenant-pipeline-rp".
